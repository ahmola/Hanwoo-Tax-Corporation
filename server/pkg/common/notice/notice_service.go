...
func (svc *NoticeService) CreateNotice(notice *Notice) error {
	var functionName = "CreateNotice"
	if err := svc.Repo.Create(notice); err != nil {
		return common.CommitError(serviceName, functionName,
...
func (svc *NoticeService) GetNoticesByTitle(title string) ([]Notice, error) {
...
func (svc *NoticeService) GetNoticesByContent(content string) ([]Notice, error) {
...
func (svc *NoticeService) GetNoticesByCategory(category string) ([]Notice, error) {
...
func (svc *NoticeService) GetNoticesByIsImportant(isImportant bool) ([]Notice, error) {
...
func (svc *NoticeService) UpdateNotice(notice *Notice) error {
