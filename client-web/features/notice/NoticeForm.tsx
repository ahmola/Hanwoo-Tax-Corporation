...
import { NOTICE_ITEMS } from "@/features/notice/Constants";
      ...
      <div className="flex flex-col gap-4">
        {NOTICE_ITEMS.map((item) => (
          ...
          >
            ...
            {/* 화살표 아이콘 (호버시 이동 효과) */}
            <div className="hidden md:block text-slate-300 group-hover:text-blue-500 group-hover:translate-x-1 transition">
              <ChevronRight />
            </div>
          </Link>
        ))}
